...
public class StatementsProcessorRestControllerTest {
    ...
    @Test
    public void achieveCodeCoverage() {
        ...
        Transaction t3=new Transaction(1,"2", new BigDecimal(200.00),new BigDecimal(-100.00),"A",new BigDecimal(100.00));
        Transaction t4=new Transaction(1,"2", new BigDecimal(200.00),new BigDecimal(-100.00),"A",new BigDecimal(200.00));
